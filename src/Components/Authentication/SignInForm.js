...
const SignInForm = () => {
  ...
  const formSubmitHandler = async (e) => {
    ...
    await fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyByo3wtTGJq3O2YqT7pak6H9SoEX03jWbs",
      {
        method: "POST",
        body: JSON.stringify({
          email: enteredEmail,
  ...
  return (
    ...
    >
      ...
      <div className="d-flex flex-column w-75 align-items-center text-center">
        ...
        <a className="text-decoration-none text-dark" href="/sign-up">New User? Sign Up</a>
      </div>
    </form>
  );
};
